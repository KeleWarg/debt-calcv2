...
const DEFAULT_CAROUSEL: CarouselSlide[] = [
  ...
  { src: '/hero-phone-portrait.jpg', alt: 'Woman reviewing Forbes Advisor savings dashboard on phone', fit: 'contain' },
]
    ...
    <div className={cn(
      ...
      >
        <div className="w-1/2 flex items-center justify-center py-10 xl:py-14 pl-10 xl:pl-16 pr-6">
          <div
            className="relative w-full max-w-[624px] rounded-2xl overflow-hidden aspect-[3/4] bg-neutral-100"
